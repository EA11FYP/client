...
class Mentee extends Component {
  ...
  formSubmitHandler = async (event) => {
    ...
    const res = await fetch(
      `${process.env.REACT_APP_DOMAIN}/api/auth/mentee/signup`,
      {
        headers: {
        ...
        <div className="signup-form-layout">
          ...
          <div className="signup-form-inner-layout">
            <form onSubmit={(event) => this.formSubmitHandler(event)}>
              ...
              <div>
                <label className="signup-form-label">Location: </label>
                <br />
                <input
                  className="signup-form-input"
              ...
              <div>
                <label className="signup-form-label">CEO: </label>
                <br />
                <input
                  className="signup-form-input"
              ...
              <div>
                <label className="signup-form-label">Website: </label>
                <br />
                <input
                  className="signup-form-input"
              ...
              <div>
                <label className="signup-form-label">Linkedin: </label>
                <br />
                <input
                  className="signup-form-input"
              ...
              <div>
                <label className="signup-form-label">Domain: </label>
                <br />
                <input
                  className="signup-form-input"
              ...
              <div>
                <label className="signup-form-label">Funding: </label>
                <br />
                <input
                  className="signup-form-input"
              ...
              <div>
                <label className="signup-form-label">Founder(s): </label>
                <br />
                <input
                  className="signup-form-input"
              ...
              <div>
                <label className="signup-form-label">Bio: </label>
                <br />
                <textarea
